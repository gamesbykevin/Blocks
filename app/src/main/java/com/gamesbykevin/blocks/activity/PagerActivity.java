...
import com.gamesbykevin.blocks.fragment.PageFragment;
...
public class PagerActivity extends BaseActivity {
    ...
    public PagerActivity(final int pages) {
        this.pages = pages;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getCustomPager().setAdapter(new PagerAdapter(getSupportFragmentManager()));
    }
